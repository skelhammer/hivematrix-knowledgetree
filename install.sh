#!/bin/bash
#
# HiveMatrix KnowledgeTree - Minimal Installation Script
...
echo ""
echo "KnowledgeTree requires Neo4j database configuration."
echo ""
echo "Next steps:"
echo "  1. Read README.md for full setup instructions"
echo "  2. Ensure Neo4j is installed and running"
